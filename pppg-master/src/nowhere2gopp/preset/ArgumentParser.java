...
public class ArgumentParser {
    ...
    /**
     * Flag um Spieler in die Registry zu stellen.
     * @return boolean ob ein Spieler in Registry gestellt werden soll
     * @throws ArgumentParserException von getFlag(String) 
     */
    ...
    /**
     * Setting fuer den Host des roten Spielers, falls er remote sein sollte.
     * @return String fuer Host des roten Spielers
     * @throws ArgumentParserException von getSetting(String)
     */
	public String getHostRed() throws ArgumentParserException{
		return (String)getSetting("hostred");
	}

    /**
     * Setting fuer den Host des blauen Spielers, falls er remote sein sollte 
     * @return String fuer Host des blauen Spielers
     * @throws ArgumentParserException von getSetting(String)
     */
	public String getHostBlue() throws ArgumentParserException{
		return (String)getSetting("hostblue");
	}

    /**
     * Setting fuer den Namen des roten Spielers, falls er remote sein sollte.
     * @return String fuer Namen des roten Spielers
     * @throws ArgumentParserException von getSetting(String)
     */
	public String getNameRed() throws ArgumentParserException{
		return (String)getSetting("namered");
	}

    /**
     * Setting fuer den Name des blauen Spielers, falls er remote sein sollte.
     * @return String fuer Namen des blauen Spielers
     * @throws ArgumentParserException von getSetting(String)
     */
	public String getNameBlue() throws ArgumentParserException{
		return (String)getSetting("nameblue");
	}

    /**
     * Setting fuer den Namen des Spielers, der in die Registry gestellt wird.
     * @return String fuer Namen des in die Registry einzutragenden Spielers
     * @throws ArgumentParserException von getSetting(String)
     */
	public String getNetName() throws ArgumentParserException{
		return (String)getSetting("netname");
	}

    /**
     * Setting fuer den PlayerType des Spielers, 
     * der in die Registry gestellt wird.
     * @return PlayerType des in die Registry einzutragenden Spielers
     * @throws ArgumentParserException von getSetting(String) und 
     * 			von parsePlayerType(String)
     */
	public PlayerType getNetPlayer() throws ArgumentParserException {
        return parsePlayerType((String) getSetting("netplayer"));
    }

    /**
     * Setting fuer den Host des Spielers, der in die Registry gestellt wird.
     * @return String fuer Host des in die Registry einzutragenden Spielers
     * @throws ArgumentParserException von getSetting(String)
     */
    public String getNetHost() throws ArgumentParserException{
		return (String)getSetting("nethost");
	}

    /**
     * Flag um externe Fenster zu deaktivieren (auszer der Graphik).
     * Dient hauptaechlich fuer statistische Auswertung der Spiele.
     * @return boolean zum Anzeigen der externen Fenster
     * @throws ArgumentParserException von getFlag(String)
     */
    public boolean getShowExternalWindow() throws ArgumentParserException{
        return getFlag("win");
    }
}
